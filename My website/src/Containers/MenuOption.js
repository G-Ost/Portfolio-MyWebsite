...
function MenuOption(props) {
    ...
    const imgStyle = { position: "absolute", zIndex: "10", height: sizeUnit / 3, right: sizeUnit / 15, pointerEvents: "auto" }
    return (
        <div ref={mainDivRef} style={{ ...menuOptionStyle, backgroundColor: props.color }}>
