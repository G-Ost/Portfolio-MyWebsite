...
function Frame(props) {
  ...
  let frameStyle = {
    ...
    top: "50%",
    left: "50%",
    marginLeft: -sizeUnit / 2,
    marginTop: -sizeUnit / 2,
    strokeWidth: sizeUnit / 20,
  };
    ...
    <div className="Frame" style={frameStyle}>
      ...
      {!props.isMenuVisible && (
        <Button
          ...
          sizeUnit={sizeUnit}
          onCLickFunction={onStartButtonClick}
          color={"Black"}
        >
          Click me!
        </Button>
      ...
      {props.isMenuVisible && (
        <Button
          buttonId={"backToStartButton"}
          sizeUnit={sizeUnit}
          onCLickFunction={backToStart}
        >
          Go back
        </Button>
      )}
