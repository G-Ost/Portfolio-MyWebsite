...
function Menu(props) {
  ...
  const { sizeUnit, changeElementPosition, menuStyle } =
  ...
  React.useEffect(spreadMenuButtons);
      ...
      for (let element of elements) {
        setTimeout(() => {
          changeElementPosition(
            movementCoordinates[i][0],
            movementCoordinates[i][1],
            0.15,
            element
          );
        }, 1 + i * 150);
  ...
  function focusButtonsBack() {
    ...
    for (let i = 0; i < elements.length; i++) {
      setTimeout(() => {
        changeElementPosition(0, 0, 0.15, elements[i]);
      }, 1 + i * 150);
    }
  }
  ...
  return (
    <div className="Menu" style={menuStyle}>
      <Button
        givenRef={menuOption1Ref}
        buttonId={"menuOption1"}
        onCLickFunction={() => {
          activateMenuOption(menuOption1Ref, "Projects");
        }}
        sizeUnit={sizeUnit}
        color={"#1fbfb8"}
      >
      ...
      <Button
        givenRef={menuOption2Ref}
        buttonId={"menuOption2"}
        onCLickFunction={() => {
          activateMenuOption(menuOption2Ref, "Contact");
        }}
        sizeUnit={sizeUnit}
        color={"#05716c"}
      >
      ...
      <Button
        givenRef={menuOption3Ref}
        buttonId={"menuOption3"}
        onCLickFunction={() => {
          activateMenuOption(menuOption3Ref, "CV");
        }}
        sizeUnit={sizeUnit}
        color={"#1978a5"}
      >
      ...
      <Button
        givenRef={menuOption4Ref}
        buttonId={"menuOption4"}
        onCLickFunction={() => {
          activateMenuOption(menuOption4Ref, "About");
        }}
        sizeUnit={sizeUnit}
        color={"#031163"}
      >
